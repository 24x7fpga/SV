...
if { [llength $argv] != 2 } {
    puts "Usage: vivado -mode batch -source sv_run.tcl -tclargs <project_name> <project_location>"
    exit 1
}
...
# default simulation runtime is removed; default sim time is set to 1000ns
